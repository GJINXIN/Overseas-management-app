...
public class owntiezixqy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.owntiezixqy);
...
//        final List<HashMap<String,String>> data = new ArrayList<>();
    ...
    public void replysubmit(View view){
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                replyedit.setText("");
                Looper.prepare();
                Toast.makeText(owntiezixqy.this,"评论成功",Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        });
        SimpleAdapter tzreplyAdapter= new SimpleAdapter(this,
    ...
    public void tiezishanchu(View view){
        OkHttpClient okHttpClient = new OkHttpClient();
        Request.Builder builder = new Request.Builder();
        Request request = builder.get().url(weburl + "servlet/adDeleteowntieziServlet?tid="+tzhftzid+"").build();
        Call call = okHttpClient.newCall(request);
        finish();
        call.enqueue(new Callback() {
            @Override
            ...
            @Override
            public void onResponse(Response response) throws IOException {
                Intent intent = new Intent(owntiezixqy.this, owntiezi.class);
                startActivity(intent);
                Looper.prepare();
                Toast.makeText(owntiezixqy.this,"删除成功",Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        });
    }
